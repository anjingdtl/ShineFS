 ...
 * android.icu.util.ChineseCalendar 在本机模拟器（API 37.1）对农历字段的呈现代码
 * 存在系统性问题——如 1900-12-31 与 2000-12-31 均输出「农历十一月三十一日」
 * （非法农历日；权威库 lunar_python 与内置历表一致输出腊月初六）。
 * 故 **ICU 不可用作本项目农历核验源**；交叉核验改用 lunar_python（构建期，
