...
data class DivinationCase(
    ...
    /** 定盘瞬间真实快照字段（V2.1）；纯时间卦保持为空。 */
    val snapshotCapturedAt: Long? = null,
    val holdPose: String? = null,
    val holdPoseConfidence: Float? = null,
    val poseStableMillis: Long? = null,
    val displayRotation: Int? = null,
    val pitchDeg: Float? = null,
    val rollDeg: Float? = null,
    val stabilityStdDeg: Float? = null,
    val orientationAccuracy: String? = null,
    val magneticAccuracy: String? = null,
    val magneticMagnitudeUt: Float? = null,
    val magneticInterference: Boolean? = null,
